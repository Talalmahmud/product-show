...
const Cart = ({
  ...
  return (
    <div className="w-full  xl:w-[600px] h-full xl:h-[800px] border-2 px-2 rounded-md bg-white">
      <h2 className="text-2xl font-bold flex justify-center items-center border-b-2 ">
        Cart List
      </h2>
